...
class MainActivity : AppCompatActivity() {
    ...
    private fun openPlayer(channel: TvChannel) {
        ...
        val intent = Intent(this, PlayerActivity::class.java)
            ...
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_ENABLED, channel.officialAppWidgetBar?.forecastEnabled ?: true)
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_DAYS, channel.officialAppWidgetBar?.forecastDays ?: 5)
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_ANIMATION_ENABLED, channel.officialAppWidgetBar?.forecastAnimationEnabled ?: true)
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_TRAVEL_SECONDS, channel.officialAppWidgetBar?.forecastTravelSeconds ?: 12)
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_PAUSE_SECONDS, channel.officialAppWidgetBar?.forecastPauseSeconds ?: 3)
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_CARD_ANIMATION, channel.officialAppWidgetBar?.forecastCardAnimation ?: "stagger_up")
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_DISPLAY_MODE, channel.officialAppWidgetBar?.forecastDisplayMode ?: "always")
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_DISPLAY_MINUTES, channel.officialAppWidgetBar?.forecastDisplayMinutes ?: 5)
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_LATITUDE, channel.officialAppWidgetBar?.forecastLatitude ?: -8.0476)
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_LONGITUDE, channel.officialAppWidgetBar?.forecastLongitude ?: -34.8770)
            .putExtra(PlayerActivity.EXTRA_WIDGET_FORECAST_TIMEZONE, channel.officialAppWidgetBar?.forecastTimezone ?: "America/Sao_Paulo")
