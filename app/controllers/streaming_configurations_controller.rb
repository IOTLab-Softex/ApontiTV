class StreamingConfigurationsController < ApplicationController
  ...
  def streaming_configuration_params
    params.require(:streaming_configuration).permit(
      ...
      :widget_forecast_days,
      :widget_forecast_animation_enabled,
      :widget_forecast_travel_seconds,
      :widget_forecast_pause_seconds,
      :widget_forecast_card_animation,
      :widget_forecast_display_mode,
      :widget_forecast_display_minutes,
      :widget_forecast_latitude,
      :widget_forecast_longitude,
      :widget_forecast_timezone,
      :widget_weather_default_image,
      :widget_weather_sun_image,
      :widget_weather_rain_image,
      :widget_weather_cloud_image,
